...
$VIEW_RESULTS_STRING = 'Voir les résultats';
$DUPLICATE_VOTE_ERROR_MSG = 'Vous avez déja vote!';
$NO_VOTE_SELECTED_ERROR_MSG = 'Vous avez oublier de sélectionner une valeur!';
...
$p->add_value("2", "Tout de suites (La nuit de noces est faite pour ça!!)");
...
$p = new Poll;
$p->question = "Où devons-nous vivre?";				
...
$p = new Poll;
$p->question = "Où devrions-nous aller en Lune de Miel?";	
$p->returnToURL = "polls.php";				
